    ...
    <div className='w-full flex justify-center items-center bg-[#0000004a] backdrop-blur-xl min-h-20 fixed top-0 left-0 z-50 px-4' >
      <div className='flex flex-row justify-between items-center container max-w-333 px-4 md:px-10 '>
        ...
        <div className='flex flex-row gap-4 items-center text-lg font-semibold max-[860px]:hidden'>
          ...
          <NavLink to={"/Login"} className={({isActive})=>" flex flex-row gap-2.5 items-center text-[#8F96A3] dark:text-[#7b818d]  justify-center hover:bg-gray-200  dark:hover:bg-gray-800 p-2.5 rounded-lg transition duration-200 " + `${isActive ? "bg-gray-200 dark:bg-gray-800 ":"bg-none"}`}><GoSignOut /> <p className='hidden lg:block'>Signout</p></NavLink>
        </div>
        {
          value?
          <SideMenu/>:null
